...
export type GetCartUsingCartApiQueryVariables = Exact<{
  cartId: Scalars["ID"];
}>;
...
export type GetCartItemCountUsingCartApiQueryVariables = Exact<{
  cartId: Scalars["ID"];
}>;
...
export type CreateCartUsingCartApiMutationVariables = Exact<{
  input: CartInput;
}>;

export type CreateCartUsingCartApiMutation = {
  __typename?: "Mutation";
  cartCreate?: {
    __typename?: "CartCreatePayload";
    cart?: {
...
export type AddCartItemUsingCartApiMutationVariables = Exact<{
  cartId: Scalars["ID"];
  lineItem: CartLineInput;
}>;

export type AddCartItemUsingCartApiMutation = {
  __typename?: "Mutation";
  cartLinesAdd?: {
    __typename?: "CartLinesAddPayload";
    cart?: {
...
export type RemoveCartItemUsingCartApiMutationVariables = Exact<{
  cartId: Scalars["ID"];
  lineItemId: Scalars["ID"];
}>;

export type RemoveCartItemUsingCartApiMutation = {
  __typename?: "Mutation";
  cartLinesRemove?: {
    __typename?: "CartLinesRemovePayload";
...
export const GetCartUsingCartApiDocument = `
  ...
  cart(id: $cartId) {
    ...
    `;
export const useGetCartUsingCartApiQuery = <
  TData = GetCartUsingCartApiQuery,
  TError = unknown
>(
  client: GraphQLClient,
  variables: GetCartUsingCartApiQueryVariables,
  options?: UseQueryOptions<GetCartUsingCartApiQuery, TError, TData>,
  headers?: RequestInit["headers"]
) =>
  useQuery<GetCartUsingCartApiQuery, TError, TData>(
    ["getCartUsingCartApi", variables],
    fetcher<GetCartUsingCartApiQuery, GetCartUsingCartApiQueryVariables>(
      client,
      GetCartUsingCartApiDocument,
      variables,
      headers
    ),
    options
...
useGetCartUsingCartApiQuery.getKey = (
  variables: GetCartUsingCartApiQueryVariables
) => ["getCartUsingCartApi", variables];
export const useInfiniteGetCartUsingCartApiQuery = <
  TData = GetCartUsingCartApiQuery,
  TError = unknown
>(
  pageParamKey: keyof GetCartUsingCartApiQueryVariables,
  client: GraphQLClient,
  variables: GetCartUsingCartApiQueryVariables,
  options?: UseInfiniteQueryOptions<GetCartUsingCartApiQuery, TError, TData>,
  headers?: RequestInit["headers"]
) =>
  useInfiniteQuery<GetCartUsingCartApiQuery, TError, TData>(
    ["getCartUsingCartApi.infinite", variables],
    (metaData) =>
      fetcher<GetCartUsingCartApiQuery, GetCartUsingCartApiQueryVariables>(
        client,
        GetCartUsingCartApiDocument,
...
useInfiniteGetCartUsingCartApiQuery.getKey = (
  variables: GetCartUsingCartApiQueryVariables
) => ["getCartUsingCartApi.infinite", variables];
useGetCartUsingCartApiQuery.fetcher = (
  client: GraphQLClient,
  variables: GetCartUsingCartApiQueryVariables,
  headers?: RequestInit["headers"]
) =>
...
export const GetCartItemCountUsingCartApiDocument = `
  ...
  cart(id: $cartId) {
    ...
    `;
export const useGetCartItemCountUsingCartApiQuery = <
  TData = GetCartItemCountUsingCartApiQuery,
  TError = unknown
>(
  client: GraphQLClient,
  variables: GetCartItemCountUsingCartApiQueryVariables,
  options?: UseQueryOptions<GetCartItemCountUsingCartApiQuery, TError, TData>,
  headers?: RequestInit["headers"]
) =>
  useQuery<GetCartItemCountUsingCartApiQuery, TError, TData>(
    ["getCartItemCountUsingCartApi", variables],
    fetcher<
      GetCartItemCountUsingCartApiQuery,
      GetCartItemCountUsingCartApiQueryVariables
    >(client, GetCartItemCountUsingCartApiDocument, variables, headers),
    options
  );
...
export const useInfiniteGetCartItemCountUsingCartApiQuery = <
  TData = GetCartItemCountUsingCartApiQuery,
  TError = unknown
>(
  pageParamKey: keyof GetCartItemCountUsingCartApiQueryVariables,
  client: GraphQLClient,
  variables: GetCartItemCountUsingCartApiQueryVariables,
  ...
  useInfiniteQuery<GetCartItemCountUsingCartApiQuery, TError, TData>(
    ["getCartItemCountUsingCartApi.infinite", variables],
    (metaData) =>
      fetcher<
        GetCartItemCountUsingCartApiQuery,
        GetCartItemCountUsingCartApiQueryVariables
      >(
        client,
        GetCartItemCountUsingCartApiDocument,
        { ...variables, ...(metaData.pageParam ?? {}) },
        headers
      )(),
    options
...
useInfiniteGetCartItemCountUsingCartApiQuery.getKey = (
  variables: GetCartItemCountUsingCartApiQueryVariables
) => ["getCartItemCountUsingCartApi.infinite", variables];
useGetCartItemCountUsingCartApiQuery.fetcher = (
  client: GraphQLClient,
  variables: GetCartItemCountUsingCartApiQueryVariables,
  headers?: RequestInit["headers"]
) =>
...
export const CreateCartUsingCartApiDocument = `
  ...
  cartCreate(input: $input) {
    ...
    `;
export const useCreateCartUsingCartApiMutation = <
  TError = unknown,
  TContext = unknown
>(
  client: GraphQLClient,
  ...
  useMutation<
    ...
    TContext
  >(
    ["createCartUsingCartApi"],
    (variables?: CreateCartUsingCartApiMutationVariables) =>
      fetcher<
        CreateCartUsingCartApiMutation,
        CreateCartUsingCartApiMutationVariables
      >(client, CreateCartUsingCartApiDocument, variables, headers)(),
    options
  );
useCreateCartUsingCartApiMutation.getKey = () => ["createCartUsingCartApi"];

useCreateCartUsingCartApiMutation.fetcher = (
  client: GraphQLClient,
  variables: CreateCartUsingCartApiMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
export const AddCartItemUsingCartApiDocument = `
  ...
  cartLinesAdd(cartId: $cartId, lines: [$lineItem]) {
    ...
    `;
export const useAddCartItemUsingCartApiMutation = <
  TError = unknown,
  TContext = unknown
>(
  client: GraphQLClient,
  ...
  useMutation<
    ...
    TContext
  >(
    ["addCartItemUsingCartApi"],
    (variables?: AddCartItemUsingCartApiMutationVariables) =>
      fetcher<
        AddCartItemUsingCartApiMutation,
        AddCartItemUsingCartApiMutationVariables
      >(client, AddCartItemUsingCartApiDocument, variables, headers)(),
    options
  );
useAddCartItemUsingCartApiMutation.getKey = () => ["addCartItemUsingCartApi"];

useAddCartItemUsingCartApiMutation.fetcher = (
  client: GraphQLClient,
  variables: AddCartItemUsingCartApiMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
export const UpdateCartItemUsingCartApiDocument = `
  ...
  cartLinesUpdate(cartId: $cartId, lines: $lines) {
    ...
    `;
export const useUpdateCartItemUsingCartApiMutation = <
  TError = unknown,
  TContext = unknown
>(
  client: GraphQLClient,
  ...
  useMutation<
    ...
    TContext
  >(
    ["updateCartItemUsingCartApi"],
    (variables?: UpdateCartItemUsingCartApiMutationVariables) =>
      fetcher<
        UpdateCartItemUsingCartApiMutation,
        UpdateCartItemUsingCartApiMutationVariables
      >(client, UpdateCartItemUsingCartApiDocument, variables, headers)(),
    options
  );
useUpdateCartItemUsingCartApiMutation.getKey = () => [
  "updateCartItemUsingCartApi",
];

useUpdateCartItemUsingCartApiMutation.fetcher = (
  client: GraphQLClient,
  variables: UpdateCartItemUsingCartApiMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
export const RemoveCartItemUsingCartApiDocument = `
  ...
  cartLinesRemove(cartId: $cartId, lineIds: [$lineItemId]) {
    ...
    `;
export const useRemoveCartItemUsingCartApiMutation = <
  TError = unknown,
  TContext = unknown
>(
  client: GraphQLClient,
  ...
  useMutation<
    ...
    TContext
  >(
    ["removeCartItemUsingCartApi"],
    (variables?: RemoveCartItemUsingCartApiMutationVariables) =>
      fetcher<
        RemoveCartItemUsingCartApiMutation,
        RemoveCartItemUsingCartApiMutationVariables
      >(client, RemoveCartItemUsingCartApiDocument, variables, headers)(),
    options
  );
useRemoveCartItemUsingCartApiMutation.getKey = () => [
  "removeCartItemUsingCartApi",
];

useRemoveCartItemUsingCartApiMutation.fetcher = (
  client: GraphQLClient,
  variables: RemoveCartItemUsingCartApiMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
export const GetCollectionByHandleDocument = `
    query GetCollectionByHandle($handle: String!, $after: String) {
  collection(handle: $handle) {
    id
    handle
    products(first: 20, sortKey: CREATED, reverse: true, after: $after) {
      ...PaginatedProductList
    }
  }
}
